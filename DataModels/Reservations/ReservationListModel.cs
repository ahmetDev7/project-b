...
{
    private static List<Reservation> _reservations = JsonDataAccessor<Reservation>.LoadData("JsonFiles/Reservations.json") ?? new List<Reservation>();
    ...
    public static void AddReservation(Reservation reservation)
    {
        ...
        JsonDataAccessor<Reservation>.WriteData("JsonFiles/Reservations.json", _reservations);
    }
